...
<div class="wrap">
<h2><?php _e( 'SMS Subscribers', 'txtimpact' )?></h2>
...
<th scope="col" id="phonenumber" class="manage-column column-phonenumber"><span><?php _e( 'Phone Number', 'txtimpact' )?></span></th>
<th scope="col" id="created" class="manage-column column-created"><span><?php _e( 'Subscribe Date', 'txtimpact' )?></span></th>
</tr>
</thead>
<tfoot>
<tr>
...
<th scope="col" class="manage-column column-created"><span><?php _e( 'Subscribe Date', 'txtimpact' )?></span></th>
</tr>
</tfoot>
<tbody id="the-list">
